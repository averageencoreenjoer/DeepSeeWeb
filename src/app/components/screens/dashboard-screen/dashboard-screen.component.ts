...
@Component({
  ...
  standalone: true,
  imports: [GridsterComponent, GridsterItemComponent, WidgetComponent, I18nPipe]
})
...
/*    // TODO: remove this ************
  ...
  ctxEdit() {
    ...
    this.sbs.showComponent({
      component: import('./../../editor/widget-editor/widget-editor.component'),
      single: true,
      inputs: {widget: this.ctxItem}
    });
    this.hideContextMenu();
  }
...
<body>${html}</body>
  ...
  private subscribeForSidebarAnim() {
    this.sidebarAnimEnd$.subscribe(() => {
      this.gridster.onResize();
    });
  }
}
