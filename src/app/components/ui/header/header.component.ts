...
@Component({
  ...
  standalone: true,
  imports: [RouterLink, ShareDashboardComponent, SearchInputComponent, FormsModule, AsyncPipe, I18nPipe]
})
export class HeaderComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  toggleMenu() {
    if (this.ss.sidebarToggle.value) {
      ...
      this.ss.showComponent({component: import('./../../ui/menu/menu.component')});
    }
  }
